...
public class PostroadUI {
	...
	public static void addComponentsToPane(Container pane) {
		...
		providerButton = new JButton("省际出口流量报表");
		gridbagC.fill = GridBagConstraints.HORIZONTAL;
		gridbagC.gridx = 0;
		gridbagC.gridy = 2;
		...
		providerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				excelAction.providerOutFlowDire("LL", filesUrl);
				String message = resultArea.getText() + "\n"
						+ "省际出口流量流向报表生成成功！文件名：省际出口流量流向.xls";
